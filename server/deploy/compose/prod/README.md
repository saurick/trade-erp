...
```bash
cd /path/to/trade-erp/server/deploy/compose/prod
...
export DB_URL='mysql://root:***@192.168.0.106:3306/trade_erp?charset=utf8mb4&parseTime=true&loc=Local&interpolateParams=true'
